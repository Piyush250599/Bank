...
<html>
    ...
    <body>
        ...
        props.put("mail.smtp.user", "mygmailid@gmail.com");
        ...
        props.put("mail.smtp.socketFactory.fallback", "false"); 
                ...
                message.setFrom(new InternetAddress("mygmailid@gmail.com"));
                message.addRecipient(RecipientType.TO, new InternetAddress(email));
                message.saveChanges();
                Transport transport = session1.getTransport("smtp");
                transport.connect("smtp.gmail.com", "mygmailid@gmail.com", "mygmailpassword");
